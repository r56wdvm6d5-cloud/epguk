...
# Manual/Force Push Script for TV2_epg.xml
# This script manually pushes the TV2_epg.xml file from TV2 folder to GitHub

set -e

# Configuration
SOURCE_DIR="/Users/ah/CascadeProjects/windsurf-project/final_multi_system/TV2/TV2 Github"
SOURCE_FILE="TV2_epg.xml"
...
BRANCH="main"
TARGET_PATH="TV2 Github/TV2_epg.xml"
...
print_status "Starting manual push process for TV2_epg.xml"
...
print_status "Copying TV2_epg.xml from TV2 folder..."
...
COMMIT_MESSAGE="Manual force push TV2_epg.xml - $(date '+%Y-%m-%d %H:%M:%S')"
...
print_success "TV2_epg.xml has been successfully pushed to GitHub!"
print_success "File location: https://github.com/r56wdvm6d5-cloud/epguk/blob/main/TV2%20Github/TV2_epg.xml"
