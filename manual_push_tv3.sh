...
# Manual/Force Push Script for TV3_epg.xml
# This script manually pushes the TV3_epg.xml file from TV3 folder to GitHub

set -e

# Configuration
SOURCE_DIR="/Users/ah/CascadeProjects/windsurf-project/final_multi_system/TV3/TV3 Github"
SOURCE_FILE="TV3_epg.xml"
...
print_status "Starting manual push process for TV3_epg.xml"
...
COMMIT_MESSAGE="Manual force push TV3_epg.xml - $(date '+%Y-%m-%d %H:%M:%S')"
...
print_success "TV3_epg.xml has been successfully pushed to GitHub!"
print_success "File location: https://github.com/r56wdvm6d5-cloud/epguk/blob/main/TV3%20Github/TV3_epg.xml"
