...
# Manual/Force Push Script for Doc2_Doc2_epg.xml
# This script manually pushes the Doc2_Doc2_epg.xml file from Doc2 folder to GitHub

set -e

# Configuration
SOURCE_DIR="/Users/ah/CascadeProjects/windsurf-project/final_multi_system/Doc2/Doc2 Github"
SOURCE_FILE="Doc2_Doc2_epg.xml"
...
BRANCH="main"
TARGET_PATH="Doc2/Doc2 Github/Doc2_Doc2_epg.xml"
...
print_status "Starting manual push process for Doc2_Doc2_epg.xml"
...
print_status "Copying Doc2_Doc2_epg.xml from Doc2 folder..."
cp "$SOURCE_DIR/$SOURCE_FILE" "./$SOURCE_FILE"

# Create the target directory structure in the git repo
mkdir -p "Doc2/Doc2 Github"
...
COMMIT_MESSAGE="Manual force push Doc2_Doc2_epg.xml - $(date '+%Y-%m-%d %H:%M:%S')"
...
print_success "Doc2_Doc2_epg.xml has been successfully pushed to GitHub!"
print_success "File location: https://github.com/r56wdvm6d5-cloud/epguk/blob/main/Doc2/Doc2%20Github/Doc2_Doc2_epg.xml"
