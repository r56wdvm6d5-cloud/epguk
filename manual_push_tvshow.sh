...
# Manual/Force Push Script for tvshow_epg.xml
# This script manually pushes the tvshow_epg.xml file from Doc2:TV folder to GitHub

set -e

# Configuration
SOURCE_DIR="/Users/ah/CascadeProjects/windsurf-project/final_multi_system/Doc2:TV/DOC2:tvshow Github/Doc2"
SOURCE_FILE="tvshow_epg.xml"
...
BRANCH="main"
TARGET_PATH="DOC2:tvshow Github/Doc2/tvshow_epg.xml"
...
print_status "Starting manual push process for tvshow_epg.xml"
...
print_status "Copying tvshow_epg.xml from Doc2:TV folder..."
cp "$SOURCE_DIR/$SOURCE_FILE" "./$SOURCE_FILE"

# Create the target directory structure in the git repo (preserving GitHub structure)
mkdir -p "DOC2:tvshow Github/Doc2"
...
COMMIT_MESSAGE="Manual force push tvshow_epg.xml - $(date '+%Y-%m-%d %H:%M:%S')"
...
print_success "tvshow_epg.xml has been successfully pushed to GitHub!"
print_success "File location: https://github.com/r56wdvm6d5-cloud/epguk/blob/main/DOC2%3Atvshow%20Github/Doc2/tvshow_epg.xml"
