...
# Manual/Force Push Script for epg_combined.xml from Github folder
# This script manually pushes the epg_combined.xml file from Github folder to GitHub root
...
print_status "Copying epg_combined.xml from Github folder..."
...
COMMIT_MESSAGE="Manual force push epg_combined.xml from Github folder - $(date '+%Y-%m-%d %H:%M:%S')"
