...
# Manual/Force Push Script for TV5_epg.xml
# This script manually pushes the TV5_epg.xml file from TV5 folder to GitHub

set -e

# Configuration
SOURCE_DIR="/Users/ah/CascadeProjects/windsurf-project/final_multi_system/TV5/TV5 Github"
SOURCE_FILE="TV5_epg.xml"
...
print_status "Starting manual push process for TV5_epg.xml"
...
COMMIT_MESSAGE="Manual force push TV5_epg.xml - $(date '+%Y-%m-%d %H:%M:%S')"
...
print_success "TV5_epg.xml has been successfully pushed to GitHub!"
print_success "File location: https://github.com/r56wdvm6d5-cloud/epguk/blob/main/TV5%20Github/TV5_epg.xml"
